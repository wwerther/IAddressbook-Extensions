    ...
    <div class="contactlist">
        ...
        <form method="post" action="<?= $PHP_SELF ?>" name='ct_form'>
            ...
            <div class="person_smalltext">
                ...
                <div style="float: left;"> <a href="javascript:do_action('export_nokia_cat')"><?= $lang['export_nokia'] ?></a> </div>
                <div style="height: 1.5em;"></div>
                <div style="float: left;"> <a href="javascript:do_action('export_fbox_cat')"><?= $lang['export_fbox'] ?></a> </div>
                <div style="height: 1.5em;"></div>
